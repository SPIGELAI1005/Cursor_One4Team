...
const getDocumentsSchema = z.object({
  type: z.enum(['PDF', 'DOC', 'XLS', 'all']).optional(),
  category: z.enum(['legal', 'financial', 'strategy', 'safety', 'minutes', 'maintenance', 'training', 'emergency', 'all']).optional(),
  ...
  sortBy: z.enum(['name', 'uploadDate', 'size', 'category']).optional().default('uploadDate'),
  sortOrder: z.enum(['asc', 'desc']).optional().default('desc')
});

/**
 * GET /api/official/documents
 * Get club documents for officials
 */
...
/**
 * GET /api/official/documents/:id/download
 * Download a specific document (mock endpoint)
 */
...
/**
 * GET /api/official/documents/categories
