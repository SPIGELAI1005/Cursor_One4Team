...
export default function SignUpPage() {
  ...
  const handleRoleChange = (role: string) => {
    const newRole = role as 'member' | 'trainer' | 'admin';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Redirect based on role - FIXED: Use correct URLs
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      // For demo purposes, create a user with admin role for Google sign-up
      const userInfo = {
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4">
            Join <One4TeamText size="3xl" variant="bold" />
          </h1>
          <p className="text-lg text-gray-600">
            Create your account and start managing your sports club efficiently.
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-sm text-gray-600 space-y-2">
                <div className="flex items-start space-x-2">
                  ...
                  <span>Access to member app, profile management, payments</span>
                </div>
                <div className="flex items-start space-x-2">
                  <span className="font-medium">Trainer:</span>
                  <span>Player management, class scheduling, member access</span>
                </div>
                <div className="flex items-start space-x-2">
