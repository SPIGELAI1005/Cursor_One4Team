...
// GET /api/support/users - Get all users with filtering
...
// GET /api/support/users/:id - Get user by ID (read-only)
...
// GET /api/support/users/:id/activity - Get user activity (read-only)
