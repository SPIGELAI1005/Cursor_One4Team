...
export interface AvatarProps extends React.ComponentPropsWithoutRef<typeof AvatarPrimitive.Root> {
  /** Optional fallback text when image fails to load */
  fallback?: string
}
 ...
 * Follows One4Team design system with fallback support
 */
...
/**
 * Avatar image component with proper loading states
 */
...
/**
 * Avatar fallback component for when image is unavailable
 */
